...
CASE_DIR="$ROOT/models/Macaque_2.5million"
...
RUN_SCRIPT="$CASE_DIR/Script_autorun_ubuntu_${METHOD}_2_5M_0_40.txt"
SUMMARY="$CASE_DIR/voxfe_solver_summary_ubuntu_${METHOD}_2_5M_0_40.json"
LOG="$CASE_DIR/solver_ubuntu_${METHOD}_2_5M_0_40_stdout.log"
COORD_SUMMARY="$CASE_DIR/coordinate_export_summary_ubuntu_${METHOD}_2_5M_0_40.json"
...
echo "Solving Macaque 2.5 million with VoxFE 0.40 PETSc/MPI"
echo "Case:      $CASE_DIR"
